          ...
          <div class="modal-body">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src="views/img/productos/default/no-imagen-producto.svg" class="img-thumbnail previewImagen" width="100px">
                </div>
          ...
          <div class="modal-body">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <p class="help-block">Peso máximo 2 MB. Formato JPG o PNG.</p>
                  <img src="views/img/productos/default/no-imagen-producto.svg" class="img-thumbnail previewImagenEditar" width="100px" id="imagenActualImg">
                </div>
  ...
  $.ajax({
    ...
    success: function(respuesta){
      ...
      if(respuesta["imagen"] != "" && respuesta["imagen"] != null){
        ...
        $("#imagenActualImg").attr("src", "views/img/productos/default/no-imagen-producto.svg");
      }
