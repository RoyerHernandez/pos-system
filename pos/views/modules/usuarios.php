          ...
          <tbody>
            ...
            foreach($users as $key => $value){
              ...
              echo '<tr>
                ...
                <td>'.$value["nombre"].'</td>
                <td>'.$value["usuario"].'</td>
                <td><img src="'.(!empty($value["foto"]) ? $value["foto"] : 'views/img/usuarios/default/avatar-default.svg').'" class="img-thumbnail" width="40px"></td>
                <td>'.$value["perfil"].'</td>
                <td>';
              ...
              <div class="box-body">
                ...
                <!-- NAME INPUT -->
                  ...
                  <div class="form-group">
                    ...
                    <img src="views/img/usuarios/default/avatar-default.svg" class="img-thumbnail previewFoto" width="100px">
              ...
              <div class="box-body">
                ...
                <!-- NAME INPUT -->
                  ...
                  <div class="form-group">
                    ...
                    <img src="views/img/usuarios/default/avatar-default.svg" class="img-thumbnail previewFotoEditar" width="100px" id="fotoActualImg">
  ...
  $.ajax({
    ...
    success: function(respuesta){
      ...
      if(respuesta["foto"] != ""){
        ...
        $("#fotoActualImg").attr("src", "views/img/usuarios/default/avatar-default.svg");
      }
